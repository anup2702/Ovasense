...
page_bg_css = """
<style>
    body { background-color: #fff9fb; color: #4a4a4a; }
    .stApp { background-color: #ffffff; padding: 1rem; color: #333333; }
    section[data-testid="stSidebar"] { background-color: #ffe6f0; color: #222 !important; padding: 2rem 1rem; }
    ...
    .stDateInput>div>div>input {
        background-color: #fff !important; color: #222 !important; border: 1px solid #ccc; border-radius: 6px;
    }

    .stFileUploader>div { background-color: #fce4ec !important; color: #222 !important; }
    .stSelectbox>div>div { background-color: #fff !important; color: #222 !important; }

    label, .stSliderLabel { color: #222 !important; }

    table.calendar { background-color: #000000; border-collapse: collapse; width: 100%; }
    table.calendar th { background: #fad4e2; color: #6a1b4d; padding: 10px; }
    table.calendar td { border: 1px solid #e0e0e0; text-align: left; vertical-align: top; height: 80px; padding: 6px; font-size: 14px; background-color: #fff; color: #333; }
    .fertile { background-color: #ffe0eb !important; font-weight: bold; }
    .ovulation { background-color: #ffc9de !important; font-weight: bold; color: #b3002d !important; }
    .empty { background-color: #f5f5f5 !important; }
